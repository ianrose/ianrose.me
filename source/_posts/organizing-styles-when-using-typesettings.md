...
<span class=dropcap>I</span>f If you aren't familiar with Typesettings you can check out the [project page](http://typesettings.io/ "Typesettings Website") that has examples and documentation
